...
def check_luhn(card, valid):
    ...
    sum = (term_1_a + term_1_b + term_2 + term_3_a + term_3_b + term_4)
    sum = sum + (term_5_a + term_5_b + term_6 + term_7_a + term_7_b + term_8)
    sum = sum + (term_9_a + term_9_b + term_10 + term_11_a + term_11_b + term_12)
    sum = sum + (term_13_a + term_13_b + term_14 + term_15_a + term_15_b + term_16)
